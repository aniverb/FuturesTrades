...
#' 	
#' 	
#' Calculating mean absolute error (MAE/MAD) and means for each product type.	
#' 	
...
data.frame(types, MAEmult_mod, MAEmult_modPprime, MAEone_mod, MAEone_modP, median=medians) #separate models for each product type	
#comparing all 4 models	
	
data.frame(all_products, MAE=all_MAE, MAEprime=all_MAEprime, median=all_medians) #comparing just separate models	
