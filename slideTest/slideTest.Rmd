...
- Futures were comprised of 21 financial instruments spanning six markets  
...
How can we understand the relationships between trade volume and price volatility?
  ...
  - provides information on the effciency of futures markets which regulators can then use to decide upon market restrictions
...
- What is a compute cluster?  
    - A set of loosely or tightly connected computers that work together that can be viewed as a single system. 
    - Computer clusters have each computer set to perform the same task, controlled and scheduled by software.

##Processing Data Cont'd
...
- Used SparkSQL for parsing and reformating, treating raw data as table
    - in memory caching avoids disk reads
    - parallelization accross cores
...
par(mfrow=c(2,1))
knitr::include_graphics("C:\\Users\\anito\\Documents\\Grad_School\\JHU\\700\\thesis writeup\\hist_orig.png")
knitr::include_graphics("C:\\Users\\anito\\Documents\\Grad_School\\JHU\\700\\thesis writeup\\hist_bc.png")
```
</div>

##Understanding effects of Day and Time to Maturity
<div class="centered">
```{r, out.width = "400px", echo=F}
par(mfrow=c(2,1))
knitr::include_graphics("C:\\Users\\anito\\Documents\\Grad_School\\JHU\\700\\thesis writeup\\bc_sample_day_wMat.png")
knitr::include_graphics("C:\\Users\\anito\\Documents\\Grad_School\\JHU\\700\\thesis writeup\\time_to_mat.png")
```
</div>

##Checking normality at Market Level
<div class="centered">
```{r, out.width = "530px", echo=F}
knitr::include_graphics("C:\\Users\\anito\\Documents\\Grad_School\\JHU\\700\\thesis writeup\\types_bc_hist.png")
```
</div>

##Understanding Day Effects at Market Level
<div class="centered">
```{r, out.width = "480px", echo=F}
knitr::include_graphics("C:\\Users\\anito\\Documents\\Grad_School\\JHU\\700\\thesis writeup\\agr_scatter_transMat.png")
```
</div>

##Understanding Time to Maturity at Market Level
<div class="centered">
```{r, out.width = "520px", echo=F}
knitr::include_graphics("C:\\Users\\anito\\Documents\\Grad_School\\JHU\\700\\thesis writeup\\types_time_to_mat.png")
```
</div>
...
- Product must have at least 30 points
...
##Acknowledgements
Thanks to Professor Daniel Naiman and the Duncan Fund for their support.
